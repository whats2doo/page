...
@else
    <li>
        <a @isset($menuItem['target']) target="{{ $menuItem['target'] }}" @endif href="{{ $menuItem['href'] }}" @if($menuItem['title']=='whitepaper') title="Coming soon!" data-toggle="tooltip" @endif @if(Request::is('/'))data-scroll="{{ $menuItem['scroll'] or '' }}"@endif>
